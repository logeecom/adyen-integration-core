...
namespace Adyen\Core\Console\Commands;
 ...
 *
 * @package Adyen\Core\Console\Commands
 */
class GenerateCurrencyAmountMapCommand extends Command
{
    private const AUTOGENERATED_START_PLACEHOLDER = '/* <auto-generated> */';
    private const AUTOGENERATED_END_PLACEHOLDER = '/* </auto-generated> */';
    private const NEW_LINE_TEMPLATE = "\n    ";
    private const CLASS_PATH = '/src/BusinessLogic/Domain/Checkout/PaymentRequest/Models/Amount/Currency.php';
    private const XML_MAP_URL = 'https://www.six-group.com/dam/download/financial-information/data-center/iso-currrency/lists/list-one.xml';
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->writeln('Generating class');
        ...
        $output->writeln('Class successfully generated!');
     ...
     * @return string
     */
    private function insertAutogeneratedCode(string $classContent, string $code): string
    {
     ...
     * @return string
     */
    private function transformMapArray(array $map): string
    {
        if (empty($map)) {
            return 'private static array $map = [];';
        }
