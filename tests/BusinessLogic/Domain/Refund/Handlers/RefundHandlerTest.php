...
namespace Adyen\Core\Tests\BusinessLogic\Domain\Refund\Handlers;
 ...
 *
 * @package Adyen\Core\Tests\BusinessLogic\Domain\Refund\Handlers
 */
class RefundHandlerTest extends BaseTestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->proxy = new MockRefundProxy();
        ...
        $this->refundHandler = TestServiceRegister::getService(RefundHandler::class);
    ...
    public function testShopNotificationAdded(): void
    {
        // Arrange
        // Act
        $this->refundHandler->handle('reference', Amount::fromInt(1, Currency::getDefault()));
    ...
    public function testNotificationSuccess(): void
    {
        ...
        self::assertEquals('Refund request has been sent to Adyen.', $notification->getMessage()->getMessage());
    }
    ...
    public function testNotificationFail(): void
    {
        ...
        self::assertEquals('Refund request failed.', $notification->getMessage()->getMessage());
    }
    ...
    public function testHistoryItemSuccess(): void
    {
        ...
        self::assertEquals('refund1_psp1', $item->getPspReference());
        self::assertEquals(ShopEvents::REFUND_REQUEST, $item->getEventCode());
