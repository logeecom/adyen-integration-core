...
use Adyen\Core\Tests\Infrastructure\Common\TestComponents\ORM\Entity\StudentEntity;
...
abstract class AbstractGenericStudentRepositoryTest extends TestCase
{
    ...
    public function testStudentUpdate()
    {
        ...
        /** @var \Adyen\Core\Tests\Infrastructure\Common\TestComponents\ORM\Entity\StudentEntity $student */
