 ...
 *
 * @package Adyen\Core\Infrastructure\Http\Configuration
 */
class AutoConfiguration
{
     ...
     *
     * @param \Adyen\Core\Infrastructure\Configuration\Configuration $configService An instance of the configuration.
     * @param \Adyen\Core\Infrastructure\Http\HttpClient $httpClient An instance of the http client.
     */
     ...
     *
     * @throws \Adyen\Core\Infrastructure\Exceptions\BaseException <p>When configuration service did not implement
