...
class AsyncSocketHttpClient extends CurlHttpClient
{
     ...
     *
     * @throws \Adyen\Core\Infrastructure\Http\Exceptions\HttpRequestException
     */
     ...
     *
     * @throws \Adyen\Core\Infrastructure\Http\Exceptions\HttpRequestException Thrown when the request
